...
public class ReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yEntrys.add(new PieEntry(a3,"Food"));
        yEntrys.add(new PieEntry(a4,"Entertainment"));
        ...
        yEntrys.add(new PieEntry(a11,"Clothes"));
        yEntrys.add(new PieEntry(a12,"Rent"));
        yEntrys.add(new PieEntry(a13,"Sport"));
